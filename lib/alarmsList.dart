...
import 'package:alarm_demo_clock/editAlarm.dart';
import 'package:intl/intl.dart';
import 'package:alarm_demo_clock/util/receivedNotification.dart';
...
class _AlarmsListPageState extends State<AlarmsListPage> {
  late String _time = DateFormat.MMMMd()
      .format(DateTime.now())
      .toString();
  late String _date = DateFormat.MMMMd()
      .format(DateTime.now())
      .toString();
